...
export const path = ({ iconPrimary, iconSecondary }: PathOptions) => (
  <>
    {/* <g filter="url(#filter0_d_640_2434)">
      <path
    ...
    <path
      ...
      fill={iconPrimary}
    /> */}
    {/* <path d="M16.5 31L11.5 26L11.5 36L16.5 31Z" fill={iconSecondary} />
    <defs>
      <filter
        id="filter0_d_640_2434"
        x="0"
        y="0"
        width="32"
        height="66"
        ...
        />
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_640_2434" />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_640_2434"
          result="shape"
        />
      </filter>
    </defs> */}
